    ...
    <article className="flex flex-col mt-10">
      <p className="text-sm lg:text-xl font-normal text-primary inline-block">
        ...
        <a
          ...
          className="text-sm lg:text-base text-primary py-1 px-2 rounded-md bg-red-500/70 delay-150 hover:bg-red-500/90 duration-300"
        >
          Avoma
        </a>{" "}
      ...
      <p className="text-sm lg:text-xl font-normal text-primary mt-12">
        ...
        <a
          ...
          target="_blank noopener noreferrer"
          className="text-sm lg:text-base text-primary py-1 px-2 rounded-md bg-violet-700/70 delay-150 hover:bg-violet-700/90 duration-300"
        >
          Octarine
        </a>{" "}
